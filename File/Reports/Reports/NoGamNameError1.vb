...
Public Class NoGamNameError
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Zera3a.NoGamNameError.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNoGamNameError
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NoGamNameError = New NoGamNameError
        rpt.Site = Me.Site
        Return rpt
    End Function
